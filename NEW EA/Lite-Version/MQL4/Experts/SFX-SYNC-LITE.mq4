...
string MinBalanceHudLines()
{
   ...
   {
      const double master_bal = AccountBalance();
...
// True only when the tracked master order is closed in history.
// A failed OrderSelect on the live pool is not treated as flat.
